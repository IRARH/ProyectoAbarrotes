        ...
        <section id="registro">
            ...
            <div id="formulario">
                <form action="#" method="POST">
                    ...
                    <label class="labelNormal" for="codigo">Codigo de Barras</label>
                ...
                ?>
                            ...
                            <form action="../Clases/actualizar_stock.php" method="POST">
                                <label class="labelNormal" for="proveedor">Código Barras</label>
                                <input id="soloLectura" type="text" name="codigo_barras" value="<?= $mostrar['codigo_barras'] ?>" readonly="readonly" required />

                                <label class="labelNormal" for="proveedor">Nombre del Proveedor</label>
                                <input id="soloLectura" type="text" name="proveedor" value="<?= $mostrar['proveedor'] ?>" readonly="readonly" required />

                                <label class="labelNormal" for="nombre">Nombre del Producto</label>
                                <input id="soloLectura" type="text" name="nombre" value="<?= $mostrar['nombre_producto'] ?>" required />

                                <label class="labelNormal" for="costo_compra">Costo Compra</label>
                                <input id="soloLectura" type="text" name="costo_compra" value="<?= $mostrar['costo_compra'] ?>" readonly="readonly" required />

                                <label class="labelNormal" for="costo_venta">Costo Venta</label>
                                <input id="soloLectura" type="text" name="costo_venta" value="<?= $mostrar['costo_venta'] ?>" readonly="readonly" required />

                                <label class="labelAlterado" for="cantidad_piezas">Cantidad de Piezas</label>
                                <input class="sombreado" id="apuntar" type="text1" name="cantidad_piezas" pattern="[0-9]+" readonly="readonly" value="<?= $mostrar['cantidad_piezas'] ?>" required />

                                <label class="labelAlterado" for="cantidad_piezas_extra">Cantidad de piezas a añadir</label>
                                <input id="apuntar" type="text1" name="cantidad_piezas_extra" pattern="{-}*[0-9]+" value="0" auto required />

                                <label class="labelAlterado" for="piezas_caja">Piezas por Caja</label>
                                <input class="sombreado" id="apuntar" type="text1" name="piezas_caja" pattern="[0-9]+" readonly="readonly" value="<?= $mostrar['piezas_caja'] ?>" required />

                                <label class="labelAlterado" for="piezas_caja_extra">Piezas por caja a añadir</label>
