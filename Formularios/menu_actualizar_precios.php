        ...
        <section id="registro">
            ...
            <div id="formulario">
                <form action="#" method="POST">
                    ...
                    <label id="labelAlterado" for="codigo">Codigo de Barras</label>
                    <input type="text" name="codigo" id="codigo" autofocus required autofocus />

                    <span id="botonBuscar"> <input type="submit" id="botonValidar" value="Obtener datos" name="btn_buscar" /> </span>
                </form>
                ...
                ?>
                            <form id="actualizar" action="../Clases/actualizar_precio.php" method="POST">

                                <label for="codigo1">Codigo de Barras</label>
                                <input class="soloLectura" type="text" name="codigo1" id="codigo1" value="<?php echo $muestra['codigo_barras'] ?>" readonly="readonly" required />

                                <label for="proveedor">Nombre del Proveedor</label>
                                <input class="soloLectura" type="text" name="proveedor" id="proveedor" value="<?php echo $muestra['proveedor'] ?>" readonly="readonly" required />

                                <label for="nombre">Nombre del Producto</label>
                                <input class="soloLectura" type="text" name="nombre" id="nombre" value="<?php echo $muestra['nombre_producto'] ?>" readonly="readonly" required />
                                ...
                                <span id="botonEnviar"><input id="enviar" type="submit" value="Actualizar" name="btn_buscar" /></span>
