    ...
    <div id="palabras">
        ...
        <section id="registro">
            ...
            <header id="encabezado_registro">
                <h1>Ingreso de Productos a la Nota</h1>
            </header>
            ...
            <div id="formulario">
                <form action="../Clases/registrarProductoVenta.php" method="POST">
                    ...
                    ?>
                                    ...
                                    <input type="text" name="proveedor" value="<?= $datosProducto['proveedor'] ?>" readonly="readonly" required />

                                    <label for="nombre">Nombre del Producto</label>
                                    <input type="text" name="nombre" value="<?= $datosProducto['nombre_producto'] ?>" readonly="readonly" required />

                                    <label for="costo_compra">Costo Compra</label>
                                    <input type="text" name="costo_compra" value="<?= $datosProducto['costo_compra'] ?>" readonly="readonly" required />

                                    <label for="costo_venta">Costo Venta</label>
                                    <input type="text" name="costo_venta" value="<?= $datosProducto['costo_venta'] ?>" readonly="readonly" required />

                                    <label for="cantidad_piezas">Stock de Piezas</label>
                                    <input id="noEditable" type="text" name="cantidad_piezas" pattern="[0-9]+" readonly="readonly" value="<?= $datosProducto['cantidad_piezas'] ?>" required />

                                    <label for="cantidadRetiro">Piezas a descontar</label>
                                    <input type="text" name="cantidadRetiro" id="cantidadRetiro" pattern="{-}*[0-9]+" value="0" required /><br />
                                    ...
                                    <span id="botonEnviar"><input type="submit" id="boton" class="atributos" value="Agregar a Nota" /></span>
                </form>
